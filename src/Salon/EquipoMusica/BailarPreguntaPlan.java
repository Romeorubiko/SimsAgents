...
import EquipoMusica.Bailar;
import EquipoMusica.Musica;
	...
	public void body() {
		...
		if (simsBailando > 0 && !musicaSonando.equals(musicaPedida)) {
			...
			if (obsolescencia <= 0) {
				...
				/*
				 * Se actualiza el array de tiempos de finalización añadiendo el
				 * tiempo de finalización de la acción para el Sim actual a la última posición
				 */
