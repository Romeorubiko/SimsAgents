...
public class GastarBromaRespuestaPlan extends Plan {
	...
	public void body() {
		...
		/* Se recupera el contenido del request guardado en el primer plan a través de una creencia */
		...
		/* Se desactiva el objetivo que ha causado la ejecución de este plan*/
		...
		/* Se envía el mensaje de que ha terminado de gastar la broma. Esto se hace a través del predicado correspondiente. */
		...
		/* El teléfono ya no está ocupado, se actualiza dicha creencia */
