...
public class LavarseJacuzziPlan extends Plan {
    ...
    public void body(){
        ...
        if (obsolescencia <= 0) {
            IMessageEvent respuesta = createMessageEvent("jacuzzi_estropeado_lavarse");
            JacuzziEstropeadoLavarse jacuzziEstropeadoLavarse = new JacuzziEstropeadoLavarse();
            respuesta.setContent(jacuzziEstropeadoLavarse);
