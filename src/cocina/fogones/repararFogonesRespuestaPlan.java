...
public class repararFogonesRespuestaPlan extends Plan {

	public void body() {

		getGoalbase().getGoal("terminar_reparar_fogones").drop();
        getBeliefbase().getBelief("tiempo_fin_reparar_fogones").setFact(new Integer (0));

        RMessageEvent peticion= (RMessageEvent)getBeliefbase().getBelief("mensaje_reparar_fogones").getFact();
